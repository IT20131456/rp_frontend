...
import RoadXAvgSpeedAreaChart from "./RoadXAvgSpeedAreaChart";

import RoadXTrafficLevelAreaChart from "./RoadXTrafficLevelAreaChart";

import RoadBAllAreaChart from "./RoadBAllAreaChart";
import RoadXAvgWithTrafficLevelBar from "./RoadXAvgSpWithTrafficLevelBarChart";

import RoadBSpeedMeter from "./RoadBSpeedMeter";

import CustomRoadXDuration from "./RoadXCustomBarChartDuration";

import RoadXAll from "./RoadXAllChart";

import ReactSpeedometer from "react-d3-speedometer";
import ThreeWayJunction from "./ThreeWayJuntionLeft";

const RoadXTrafficPrediction = () => {
  ...
  const handleSaveData = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/save-dataX", {
        level,
        prediction,
        avgSpeed,
        trafficRatio,
        ...
        <Container>
          <div className="con2">
            <Row className="my-row">
              ...
              <Col sm={5}>
                <div className="mapst rotate-left">
...
export default RoadXTrafficPrediction;
