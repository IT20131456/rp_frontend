...
import RoadBAvgSpeedAreaChart from "./RoadBAvgSpeedAreaChart";

import RoadBTrafficLevelAreaChart from "./RoadBTrafficLevelAreaChart";

import RoadBAllAreaChart from "./RoadBAllAreaChart";
import RoadBAvgWithTrafficLevelBar from "./RoadBAvgSpWithTrafficLevelBarChart";

import RoadBSpeedMeter from "./RoadBSpeedMeter";

import CustomRoadBDuration from "./RoadBCustomBarChartDuration";

import RoadBAll from "./RoadBAllChart";

import ReactSpeedometer from "react-d3-speedometer";
import ThreeWayJunction from "./ThreeWayJuntionLeft";

const RoadBTrafficPrediction = () => {
        ...
        <Container>
          <div className="con2">
            <Row className="my-row">
              <Col sm={7}>
                <div className="mapst">
                  <ThreeWayJunction value1={passvalue2}/>
                </div>
              </Col>
              <Col sm={5}>
                <Row>
...
export default RoadBTrafficPrediction;
