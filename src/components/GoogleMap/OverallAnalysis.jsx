    ...
    <div className="wrapper">
      ...
      <div className="content-wrapper">
        ...
        <Container>
          <div className="con2">
            <center>
                <h2 className="ovtitle">Overall Analysis</h2>
            </center>
...
<Col sm={7}>
    <div className="cardOverallD">
        ...
        <Row>
            <Col sm={6}>
              <a href="/reportx" style={{ textDecoration: 'none' }}>
                <div className="cardP1">
                    <h4 style={{color: "black"}}>Road X </h4>
                </div>
                </a>
        ...
        <Row>
            <Col sm={6}>
              <a href="/reportB" style={{ textDecoration: 'none' }}>
                <div className="cardP1">
                    <h4 style={{color: "black"}}>Road Q </h4>
                </div>
                </a>
        ...
        <Row>
            <Col sm={6}>
              <a href="/reportA" style={{ textDecoration: 'none' }}>
                <div className="cardP1">
                    <h4 style={{color: "black"}}>Road A </h4>
                </div>
                </a>
        ...
        <Row>
            <Col sm={6}>
              <a href="/reportM" style={{ textDecoration: 'none' }}>
                <div className="cardP1">
                    <h4 style={{color: "black"}}>Road M </h4>
                </div>
                </a>
