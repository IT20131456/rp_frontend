...
import RoadMAvgSpeedAreaChart from "./RoadMAvgSpeedAreaChart";

import RoadMTrafficLevelAreaChart from "./RoadMTrafficLevelAreaChart";

import RoadBAllAreaChart from "./RoadBAllAreaChart";
import RoadMAvgWithTrafficLevelBar from "./RoadMAvgSpWithTrafficLevelBarChart";

import RoadBSpeedMeter from "./RoadBSpeedMeter";

import CustomRoadMDuration from "./RoadMCustomBarChartDuration";

import RoadMAll from "./RoadMAllChart";

import ReactSpeedometer from "react-d3-speedometer";
import ThreeWayJunction from "./ThreeWayJuntionLeft";

const RoadMTrafficPrediction = () => {
  ...
  const handleSaveData = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/save-dataM", {
        level,
        prediction,
        avgSpeed,
        trafficRatio,
...
export default RoadMTrafficPrediction;
